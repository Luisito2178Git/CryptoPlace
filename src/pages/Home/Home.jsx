  ...
  return (
    <div className='home'>
      ...
      <div className="hero">
        ...
        <p>Welcome to my crypto currency website, here you can search the most popular crypto coins and check some details about it. So lets started, try to search one crypto in the next search bar,</p>
